                        ...
                        <div class="row" style="margin-bottom:40px">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_code" class="form-control" value="{{ old('name') ?? $products->product_code }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" class="form-control"
                                        value="{{ old('name') ?? $products->price }}">
                                </div>
                                <div class="form-group">
                                    <label>Sản phẩm có nổi bật</label>
                                    <select name="is_highlight" class="form-control">
                                        <option <?php if($products->is_highlight == 0) {echo 'selected';} ?> value="0">Không</option>
                                        <option <?php if($products->is_highlight == 1) {echo 'selected';} ?> value="1">Có</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Số lượng</label>
                                    <input type="number" name="quantity" min="0" class="form-control" value="{{ old('name') ?? $products->quantity }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-success" name="add-product" type="submit">Sửa sản
                                    phẩm</button>
                                <button href="admin/products" class="btn btn-danger" type="reset">Huỷ bỏ</button>
                            </div>
                        </div>
